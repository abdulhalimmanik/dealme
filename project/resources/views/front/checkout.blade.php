				          ...
				          <div class="login-form signin-form">
				            ...
				            <form id="loginform" action="{{ route('user.login.submit') }}" method="POST">
				              ...
				              <div class="form-input">
				                <input type="email" name="email" placeholder="{{ $langg->lang173 }}" value="user@gmail.com" required="">
				                <i class="icofont-user-alt-5"></i>
				              </div>
				              <div class="form-input">
				                <input type="password" class="Password" name="password" placeholder="{{ $langg->lang174 }}" value="1234" required="">
